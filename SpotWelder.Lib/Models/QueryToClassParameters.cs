namespace SpotWelder.Lib.Models
{
  public class QueryToClassParameters
  {
    ...
    //TODO: Turn ClassOptions into an enumeration
    public ClassOptions ClassOptions { get; set; } = new();

    //TODO: Consolidate the enumerations into one concept
    //If there are too many options, then use a dictionary of data, like <string, bool> encapsulated in a class
